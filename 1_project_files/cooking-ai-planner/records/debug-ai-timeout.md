...
- `api/ai.js`
  - 将后端 AI provider 请求超时时间调整为 45000ms。
...
- 如果日志显示请求超过 45000ms，需继续检查 Vercel Function 最大执行时长、模型响应速度和上游 API 网关稳定性。
