...
| 2026-04-23 | 2.0-git-publish | main | `[v2-release][chore] publish current xiaofanzhuo 2.0 progress` | 发布到 GitHub：提交当前工作区改动 + 归档本轮发布动作（commit/push 结果与 hash 于发布完成后补齐到 `step-2.0-git-publish-report.md`） |
